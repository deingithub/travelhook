...
replace_headsign = {
    ...
    ("STR6", "Oppau Fritz-Haber-Str. BASF Tor12+13, Ludwigshafen"): "Oppau Fritz-Haber-Str.",
    ...
    ("STR6A", "Oppau Fritz-Haber-Str. BASF Tor12+13, Ludwigshafen"): "Oppau Fritz-Haber-Str.",
    ("STR6A", "Neuhermsheim SAP Arena S-Bahnhof, Mannheim"): "SAP Arena S-Bf",
    ("STR7", "Vogelstang Endstelle, Mannheim"): "Vogelstang",
    ("STR7", "Rheingönheim Neubruch, Ludwigshafen am Rhein"): "Rheingönheim Neubruch",
